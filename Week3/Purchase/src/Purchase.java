 ...
 * August 31, 2020
 *
 * Purpose: Create a Purchase class that has
 * appropriate attributes. Display the appropriate
 * sale information in an organized manner.
 *
...
public class Purchase {
    ...
    public static void main(String[] args) {
        ...
        int invoiceNumber = rn.nextInt(2000 - 1000 + 1) + 1000;
